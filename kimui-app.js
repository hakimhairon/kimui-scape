...
<p class="sec-desc">Two variants: dark and light. Both support collapsible submenus, user footer with icon-only actions, and a credit line. Sidebar can be toggled open/closed.</p>

<div class="demo"><div style="display:flex;gap:24px;flex-wrap:wrap">
<div>
<div class="demo-label">Dark (Collapsed Submenu)</div>
<div class="sidebar-demo" style="background:#000;color:#888;min-height:380px;display:flex;flex-direction:column">
<div style="font-weight:800;color:#fff;margin-bottom:16px;display:flex;align-items:center;gap:10px"><div style="width:32px;height:32px;background:#f97316;border-radius:10px;display:flex;align-items:center;justify-content:center"><i class="fas fa-satellite" style="color:#fff;font-size:.85rem"></i></div> OmniLens</div>
<div class="sd-item active" style="color:#fff"><i class="fas fa-home"></i> Home</div>
<div class="sd-item" style="cursor:pointer" onclick="this.classList.toggle('open');this.nextElementSibling.classList.toggle('open')"><i class="fas fa-search"></i> ObseroLens <i class="fas fa-chevron-down" style="margin-left:auto;font-size:.6rem;transition:transform .2s"></i></div>
<div class="sd-sub">
  <div class="sd-item" style="padding-left:38px;font-size:.8rem"><i class="fas fa-play-circle"></i> Run Discovery</div>
  <div class="sd-item" style="padding-left:38px;font-size:.8rem"><i class="fas fa-history"></i> Job History</div>
</div>
<div class="sd-item" style="cursor:pointer" onclick="this.classList.toggle('open');this.nextElementSibling.classList.toggle('open')"><i class="fas fa-scroll"></i> LogLens <i class="fas fa-chevron-down" style="margin-left:auto;font-size:.6rem;transition:transform .2s"></i></div>
<div class="sd-sub">
  <div class="sd-item" style="padding-left:38px;font-size:.8rem"><i class="fas fa-sliders-h"></i> Configuration</div>
  <div class="sd-item" style="padding-left:38px;font-size:.8rem"><i class="fas fa-network-wired"></i> ALB Logs</div>
</div>
<div style="flex:1"></div>
<div style="border-top:1px solid rgba(255,255,255,.08);padding-top:12px;display:flex;align-items:center;justify-content:space-between">
  <div style="display:flex;align-items:center;gap:8px;font-size:.85rem;color:rgba(255,255,255,.6)"><i class="fas fa-user-circle" style="font-size:1.3rem"></i> <span style="font-weight:600;color:#fff">hakim.hairon</span></div>
  <div style="display:flex;gap:4px">
    <div style="background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);border-radius:6px;padding:6px 8px;cursor:pointer;color:rgba(255,255,255,.5);font-size:.8rem"><i class="fas fa-gear"></i></div>
    <div style="background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);border-radius:6px;padding:6px 8px;cursor:pointer;color:rgba(255,255,255,.5);font-size:.8rem"><i class="fas fa-sign-out-alt"></i></div>
  </div>
</div>
<div style="text-align:center;font-size:.7rem;color:rgba(255,255,255,.2);margin-top:8px;letter-spacing:.5px">Developed by Galactic Network</div>
</div></div>

<div>
<div class="demo-label">Light (Open Submenu)</div>
<div style="background:#fff;border:1px solid var(--border);border-radius:16px;padding:20px;width:240px;color:var(--text);min-height:380px;display:flex;flex-direction:column">
<div style="font-weight:800;margin-bottom:16px;display:flex;align-items:center;gap:10px"><div style="width:32px;height:32px;background:#6366f1;border-radius:10px;display:flex;align-items:center;justify-content:center"><i class="fas fa-cloud" style="color:#fff;font-size:.85rem"></i></div> Basework</div>
...
<div style="padding:9px 14px;border-radius:10px;font-size:.85rem;font-weight:500;margin-bottom:2px;color:var(--text2);display:flex;align-items:center;gap:10px"><i class="fas fa-map" style="width:18px;text-align:center"></i> Blueprint <i class="fas fa-chevron-down" style="margin-left:auto;font-size:.55rem;color:var(--muted)"></i></div>
<div style="margin-bottom:2px">
  <div style="padding:7px 14px 7px 38px;font-size:.8rem;font-weight:500;color:var(--text2);border-radius:8px">Basic</div>
  <div style="padding:7px 14px 7px 38px;font-size:.8rem;font-weight:500;color:var(--text2);border-radius:8px">Advanced</div>
</div>
<div style="padding:9px 14px;border-radius:10px;font-size:.85rem;font-weight:500;margin-bottom:2px;color:var(--text2);display:flex;align-items:center;gap:10px"><i class="fas fa-clipboard-check" style="width:18px;text-align:center"></i> Register <i class="fas fa-chevron-down" style="margin-left:auto;font-size:.55rem;color:var(--muted)"></i></div>
<div style="margin-bottom:2px">
  <div style="padding:7px 14px 7px 38px;font-size:.8rem;font-weight:500;color:var(--text2);border-radius:8px">Create New</div>
  <div style="padding:7px 14px 7px 38px;font-size:.8rem;font-weight:500;color:var(--text2);border-radius:8px">Active</div>
</div>
<div style="flex:1"></div>
<div style="border-top:1px solid var(--border);padding-top:12px;display:flex;align-items:center;justify-content:space-between">
  <div style="display:flex;align-items:center;gap:8px;font-size:.85rem;color:var(--text2)"><i class="fas fa-user-circle" style="font-size:1.3rem"></i> <span style="font-weight:600;color:var(--text)">john.doe</span></div>
  <div style="display:flex;gap:4px">
    <div style="background:var(--bg);border:1px solid var(--border);border-radius:6px;padding:6px 8px;cursor:pointer;color:var(--muted);font-size:.8rem"><i class="fas fa-gear"></i></div>
    <div style="background:var(--bg);border:1px solid var(--border);border-radius:6px;padding:6px 8px;cursor:pointer;color:var(--muted);font-size:.8rem"><i class="fas fa-sign-out-alt"></i></div>
  </div>
</div>
<div style="text-align:center;font-size:.7rem;color:var(--muted);margin-top:8px;letter-spacing:.5px">Developed by Galactic Network</div>
</div></div>
</div></div>

<div class="sec-sub"><i class="fas fa-info-circle"></i> Sidebar Open / Close</div>
<div class="demo"><div style="display:flex;gap:24px;flex-wrap:wrap;align-items:start">
<div>
<div class="demo-label">Open State (320px)</div>
<div style="background:#000;border-radius:16px;padding:16px;width:200px;color:#888;font-size:.8rem">
<div style="font-weight:700;color:#fff;margin-bottom:12px;display:flex;align-items:center;gap:8px"><div style="width:28px;height:28px;background:#f97316;border-radius:8px;display:flex;align-items:center;justify-content:center"><i class="fas fa-satellite" style="color:#fff;font-size:.7rem"></i></div> OmniLens</div>
<div style="padding:6px 10px;border-radius:8px;font-size:.78rem;color:#fff;background:rgba(255,255,255,.1);margin-bottom:2px;display:flex;align-items:center;gap:8px"><i class="fas fa-home" style="width:14px;text-align:center"></i> Home</div>
<div style="padding:6px 10px;border-radius:8px;font-size:.78rem;margin-bottom:2px;display:flex;align-items:center;gap:8px"><i class="fas fa-search" style="width:14px;text-align:center"></i> ObseroLens</div>
<div style="padding:6px 10px;border-radius:8px;font-size:.78rem;margin-bottom:2px;display:flex;align-items:center;gap:8px"><i class="fas fa-scroll" style="width:14px;text-align:center"></i> LogLens</div>
</div></div>
<div>
<div class="demo-label">Closed State (0px)</div>
<div style="background:#000;border-radius:16px;padding:16px;width:50px;color:#888;font-size:.8rem;text-align:center">
<div style="width:28px;height:28px;background:#f97316;border-radius:8px;display:flex;align-items:center;justify-content:center;margin:0 auto 12px"><i class="fas fa-satellite" style="color:#fff;font-size:.7rem"></i></div>
<div style="margin-bottom:6px"><i class="fas fa-home" style="font-size:.8rem;color:#fff"></i></div>
<div style="margin-bottom:6px"><i class="fas fa-search" style="font-size:.8rem"></i></div>
<div style="margin-bottom:6px"><i class="fas fa-scroll" style="font-size:.8rem"></i></div>
</div></div>
<div style="flex:1;min-width:200px"><div class="demo-label">Behavior</div><ul style="font-size:.85rem;line-height:2;color:var(--text2)">
<li>Toggle via hamburger button or edge arrow</li>
<li>Collapsed: <code>width: 0</code> with <code>overflow: hidden</code></li>
<li>Main content expands: <code>margin-left: 10px</code></li>
<li>Transition: <code>all .5s cubic-bezier(.25,.8,.25,1)</code></li>
<li>Mobile: overlay mode with backdrop</li>
</ul></div>
</div></div>

<div class="sec-sub"><i class="fas fa-arrows-left-right"></i> Toggle Buttons</div>
<div class="demo"><div style="display:flex;gap:24px;flex-wrap:wrap;align-items:start">
<div>
<div class="demo-label">Edge Arrow (lz-register)</div>
<div style="display:flex;align-items:center;gap:0;height:120px">
  <div style="background:#000;border-radius:12px 0 0 12px;padding:16px;width:140px;height:100%;display:flex;flex-direction:column;justify-content:center">
    <div style="font-size:.75rem;color:#888;margin-bottom:6px"><i class="fas fa-home" style="margin-right:6px"></i>Home</div>
    <div style="font-size:.75rem;color:#888"><i class="fas fa-search" style="margin-right:6px"></i>Explore</div>
  </div>
  <div style="width:24px;height:48px;background:#f97316;border-radius:0 8px 8px 0;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#fff;font-size:.7rem;box-shadow:2px 0 8px rgba(249,115,22,.3)"><i class="fas fa-chevron-left"></i></div>
  <div style="margin-left:16px;background:var(--bg);border-radius:12px;padding:16px;height:100%;display:flex;align-items:center;color:var(--text2);font-size:.8rem">Main Content</div>
</div>
<div style="font-size:.78rem;color:var(--text2);margin-top:8px">Fixed at sidebar edge, rotates on collapse</div>
</div>
<div>
<div class="demo-label">Hamburger Button (Mobile / Top)</div>
<div style="display:flex;gap:12px;align-items:center">
  <div style="background:var(--surface);border:1px solid var(--border);border-radius:10px;width:40px;height:40px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:1rem;color:var(--text)"><i class="fas fa-bars"></i></div>
  <div style="background:var(--accent-soft);border:1px solid var(--accent);border-radius:10px;width:40px;height:40px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:1rem;color:var(--accent)"><i class="fas fa-bars"></i></div>
  <span style="font-size:.78rem;color:var(--text2)">Default → Hover</span>
</div>
<div style="font-size:.78rem;color:var(--text2);margin-top:8px">Top-left of main content, shows on mobile or collapsed</div>
</div>
<div>
<div class="demo-label">Header Toggle</div>
<div style="background:#000;border-radius:12px;padding:12px 16px;display:flex;align-items:center;justify-content:space-between;width:220px">
  <div style="display:flex;align-items:center;gap:8px"><div style="width:28px;height:28px;background:#f97316;border-radius:8px;display:flex;align-items:center;justify-content:center"><i class="fas fa-satellite" style="color:#fff;font-size:.7rem"></i></div><span style="color:#fff;font-weight:700;font-size:.85rem">OmniLens</span></div>
  <div style="background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.15);border-radius:8px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:rgba(255,255,255,.5);font-size:.65rem"><i class="fas fa-chevron-left"></i></div>
</div>
<div style="font-size:.78rem;color:var(--text2);margin-top:8px">Inside sidebar header, arrow flips on toggle</div>
</div>
</div></div>

<div class="sec-sub"><i class="fas fa-code"></i> Toggle Button Styles</div>
<div class="code"><span class="cm">/* Edge arrow (fixed at sidebar edge) */</span>
.<span class="fn">sb-edge-toggle</span> {
  <span class="attr">position</span>: fixed; <span class="attr">left</span>: <span class="num">288px</span>; <span class="attr">top</span>: <span class="num">50%</span>;
  <span class="attr">transform</span>: <span class="fn">translateY</span>(<span class="num">-50%</span>);
  <span class="attr">width</span>: <span class="num">24px</span>; <span class="attr">height</span>: <span class="num">48px</span>;
  <span class="attr">background</span>: <span class="str">#f97316</span>;
  <span class="attr">border-radius</span>: <span class="num">0 8px 8px 0</span>;
  <span class="attr">box-shadow</span>: <span class="num">2px 0 8px</span> <span class="fn">rgba</span>(<span class="num">249,115,22,.3</span>);
}
aside.<span class="fn">collapsed</span> ~ .<span class="fn">sb-edge-toggle</span> { <span class="attr">left</span>: <span class="num">0</span>; }
aside.<span class="fn">collapsed</span> .<span class="fn">sb-edge-toggle</span> i { <span class="attr">transform</span>: <span class="fn">rotate</span>(<span class="num">180deg</span>); }

<span class="cm">/* Hamburger button */</span>
.<span class="fn">sb-toggle</span> {
  <span class="attr">border</span>: <span class="num">1px</span> solid <span class="str">var(--border)</span>;
  <span class="attr">border-radius</span>: <span class="num">10px</span>;
  <span class="attr">width</span>: <span class="num">40px</span>; <span class="attr">height</span>: <span class="num">40px</span>;
}
.<span class="fn">sb-toggle</span>:<span class="kw">hover</span> {
  <span class="attr">background</span>: <span class="str">var(--accent-soft)</span>;
  <span class="attr">color</span>: <span class="str">var(--accent)</span>;
}</div>

<div class="sec-sub"><i class="fas fa-code"></i> Submenu Pattern</div>
<div class="code"><span class="cm">/* Collapsible submenu */</span>
.<span class="fn">submenu</span> { <span class="attr">overflow</span>: hidden; <span class="attr">max-height</span>: <span class="num">600px</span>; <span class="attr">transition</span>: <span class="str">max-height .2s</span>; }
.<span class="fn">submenu</span>:<span class="kw">not</span>(.<span class="fn">open</span>) { <span class="attr">max-height</span>: <span class="num">0</span>; }

<span class="cm">/* Chevron rotation */</span>
.<span class="fn">nav-arrow</span> { <span class="attr">margin-left</span>: auto; <span class="attr">font-size</span>: <span class="num">.65rem</span>; <span class="attr">transition</span>: <span class="str">transform .2s</span>; }
.<span class="fn">nav-item</span>.<span class="kw">collapsed</span> .<span class="fn">nav-arrow</span> { <span class="attr">transform</span>: <span class="fn">rotate</span>(<span class="num">-90deg</span>); }

<span class="cm">/* Footer: user + icon-only actions */</span>
.<span class="fn">sidebar-footer</span> { <span class="attr">display</span>: flex; <span class="attr">align-items</span>: center; <span class="attr">justify-content</span>: space-between; }
.<span class="fn">sidebar-logout</span> { <span class="attr">background</span>: <span class="fn">rgba</span>(<span class="num">255,255,255,.08</span>); <span class="attr">border</span>: <span class="num">1px</span> solid <span class="fn">rgba</span>(<span class="num">255,255,255,.12</span>); <span class="attr">border-radius</span>: <span class="num">8px</span>; <span class="attr">padding</span>: <span class="num">8px 12px</span>; }
.<span class="fn">sidebar-logout</span>:<span class="kw">hover</span> { <span class="attr">color</span>: <span class="str">#f87171</span>; <span class="attr">border-color</span>: <span class="str">#f87171</span>; }
.<span class="fn">sidebar-credit</span> { <span class="attr">text-align</span>: center; <span class="attr">font-size</span>: <span class="num">.8rem</span>; <span class="attr">color</span>: <span class="fn">rgba</span>(<span class="num">255,255,255,.25</span>); }

<span class="cm">/* Toggle JS */</span>
<span class="kw">function</span> <span class="fn">toggleSubmenu</span>(el) {
  el.<span class="fn">classList</span>.<span class="fn">toggle</span>(<span class="str">'collapsed'</span>);
  el.<span class="fn">nextElementSibling</span>.<span class="fn">classList</span>.<span class="fn">toggle</span>(<span class="str">'open'</span>);
}</div></div>`;
